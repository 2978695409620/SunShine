...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr, String locationSetting)
        ...
        Log.v(LOG_TAG, "Getting Weather from JSON");
    ...
    private void notifyWeather() {
        Log.d(LOG_TAG, "Notifying Weather");
    ...
    public static void configurePeriodicSync(Context context, int syncInterval, int flexTime) {
        Log.d(LOG_TAG, "Configuring Periodic Sync");
    ...
    public static void syncImmediately(Context context) {
        Log.d(LOG_TAG, "Immediately Syncing");
        ...
        Log.d(LOG_TAG, "Set To Syncable");
        ContentResolver.requestSync(account, context.getString(R.string.content_authority), bundle);
        Log.d(LOG_TAG, "Sync Has Been Requested");
    }

    public static Account getSyncAccount(Context context) {
        Log.d(LOG_TAG, "Getting Sync Account");
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
        Log.d(LOG_TAG, "On Account Created");
